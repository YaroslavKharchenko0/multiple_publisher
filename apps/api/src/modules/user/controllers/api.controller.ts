...
export class ApiController {
  ...
  @Roles(Role.USER)
  @UserAccess()
  findUserById(@TraceId() traceId: string | undefined, @Param('userId', IsStringNumberPipe) id: string) {
  ...
  @Roles(Role.USER)
  @UserAccess()
  updateUser(@TraceId() traceId: string | undefined, @Param('userId', IsStringNumberPipe) id: string, @Body() body: UpdateUserBodyDto) {
  ...
  @Roles(Role.USER)
  @UserAccess()
  deleteUser(@TraceId() traceId: string | undefined, @Param('userId', IsStringNumberPipe) id: string) {
