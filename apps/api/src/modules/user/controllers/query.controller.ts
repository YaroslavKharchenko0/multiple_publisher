...
export class QueryController {
  ...
  async findById(
    @RabbitPayload() message: FindUserByIdQuery.Request,
  ): Promise<FindUserByIdQuery.Response> {
  ...
  async findByEmail(
    @RabbitPayload() message: FindUserByEmailQuery.Request,
  ): Promise<FindUserByEmailQuery.Response> {
  ...
  async findByProvider(
    @RabbitPayload() message: FindUserByProviderIdQuery.Request,
  ): Promise<FindUserByProviderIdQuery.Response> {
