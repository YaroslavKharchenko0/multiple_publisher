...
export class CommandController {
  ...
  async create(
    @RabbitPayload() message: CreateFileMetadataCommand.Request,
  ): Promise<CreateFileMetadataCommand.Response> {
  ...
  async delete(
    @RabbitPayload() message: DeleteFileMetadataCommand.Request,
  ): Promise<CreateFileMetadataCommand.Response> {
