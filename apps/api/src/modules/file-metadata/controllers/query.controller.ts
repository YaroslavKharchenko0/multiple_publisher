import { FindFileMetadataByFileIdQuery, createSuccessResponse } from "@app/contracts";
...
export class QueryController {
  ...
  async findByFileId(@RabbitPayload() message: FindFileMetadataByFileIdQuery.Request): Promise<FindFileMetadataByFileIdQuery.Response> {
    const payload = await this.service.findByFileId(message.fileId, message.pagination);
