...
export class CommandController {
  ...
  async createRole(
    @RabbitPayload() message: CreateRoleCommand.Request,
  ): Promise<CreateRoleCommand.Response> {
  ...
  async deleteRole(
    @RabbitPayload() message: DeleteRoleCommand.Request,
  ): Promise<DeleteRoleCommand.Response> {
