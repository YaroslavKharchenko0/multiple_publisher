...
export class CommandController {
  ...
  async create(
    @RabbitPayload() message: CreateAccountProviderCommand.Request,
  ): Promise<CreateAccountProviderCommand.Response> {
  ...
  async delete(
    @RabbitPayload() message: DeleteAccountProviderCommand.Request,
  ): Promise<DeleteAccountProviderCommand.Response> {
