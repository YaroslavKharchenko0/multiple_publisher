...
import { CreateAccountProviderCommand, DeleteAccountProviderCommand } from '@app/contracts'
...
export class AdminApiController {
  ...
  @Post('/')
  @Roles(Role.ADMIN)
  create(@TraceId() traceId: string | undefined, @Body() body: CreateAccountProviderBodyDto) {
  ...
  @Delete('/:key')
  @Roles(Role.ADMIN)
  delete(@TraceId() traceId: string | undefined, @Param('key', new IsEnumPipe(ProviderKey)) key: ProviderKey) {
