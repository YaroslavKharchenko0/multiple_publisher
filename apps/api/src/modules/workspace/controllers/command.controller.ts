...
export class CommandController {
  ...
  async createWorkspaces(
    @RabbitPayload() message: CreateWorkspaceCommand.Request,
  ): Promise<CreateWorkspaceCommand.Response> {
  ...
  async deleteWorkspaces(
    @RabbitPayload() message: DeleteWorkspaceCommand.Request,
  ): Promise<DeleteWorkspaceCommand.Response> {
