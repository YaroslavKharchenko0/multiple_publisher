import { WorkspaceCreatedEvent, CreateWorkspaceUserCommand } from "@app/contracts";
...
export class EventController {
  ...
  async onCreateWorkspace(@TraceId() traceId: string, @RabbitPayload() message: WorkspaceCreatedEvent.Request) {
