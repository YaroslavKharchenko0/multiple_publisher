...
import { CreateWorkspaceRoleCommand, DeleteWorkspaceRoleCommand, FindWorkspaceRoleQuery } from "@app/contracts";
...
export class AdminApiController {
  ...
  @Get('/:role')
  @Roles(Role.ADMIN)
  findByRole(@TraceId() traceId: string | undefined, @Param('role', new IsEnumPipe(WorkspaceRole)) role: WorkspaceRole) {
  ...
  @Post('/')
  @Roles(Role.ADMIN)
  createRole(@TraceId() traceId: string | undefined, @Body() body: CreateWorkspaceRoleDto) {
  ...
  @Delete('/:role')
  @Roles(Role.ADMIN)
  deleteRole(@TraceId() traceId: string | undefined, @Param('role', new IsEnumPipe(WorkspaceRole)) role: WorkspaceRole) {
