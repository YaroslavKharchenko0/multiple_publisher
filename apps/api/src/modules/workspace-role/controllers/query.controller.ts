...
export class QueryController {
  ...
  async findByRole(
    @RabbitPayload() message: FindWorkspaceRoleQuery.Request,
  ): Promise<FindWorkspaceRoleQuery.Response> {
  ...
  async findById(
    @RabbitPayload() message: FindWorkspaceRoleByIdQuery.Request,
  ): Promise<FindWorkspaceRoleByIdQuery.Response> {
